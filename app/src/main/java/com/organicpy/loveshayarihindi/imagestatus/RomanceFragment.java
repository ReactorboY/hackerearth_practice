 ...
 * Use the {@link RomanceFragment#newInstance} factory method to
...
public class RomanceFragment extends Fragment {
    ...
    public static RomanceFragment newInstance(String param1, String param2) {
        RomanceFragment fragment = new RomanceFragment();
